...
/*Init = "=" number.*/
  ...
  static private boolean jj_3_17() {
    if (jj_scan_token(GROESSER)) return true;
    return false;
  }
  ...
  static private boolean jj_3_27() {
    if (jj_scan_token(MAL)) return true;
    return false;
  }
  ...
  static private boolean jj_3_13() {
    if (jj_scan_token(GLEICHGLEICH)) return true;
    return false;
  }
  ...
  static private boolean jj_3_29() {
    if (jj_scan_token(AUSRUF)) return true;
    return false;
  }
  ...
  static private boolean jj_3_18() {
    if (jj_scan_token(GROESSERGLEICH)) return true;
    return false;
  }
  ...
  static private boolean jj_3_12() {
    if (jj_scan_token(KAUFUND)) return true;
    if (jj_3R_14()) return true;
    return false;
  }
